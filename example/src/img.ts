...
export const background_source = require('../assets/background.png');

const card1_source = require('../assets/card1.png');
export const card1_img = Image.resolveAssetSource(card1_source).uri;
const card2_source = require('../assets/card2.png');
